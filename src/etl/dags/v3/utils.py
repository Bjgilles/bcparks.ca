...
class Strapi():
    def __init(self):
        self.strapi_base = getenv("strapi")
        self.token = getebv("downstream_pw")
...
class Parks_ETL:
    ...
    def __init__(self, downstream_pw):
        self.par_api_url_base = getenv("PAR")
        self.bcgn_api_url_base = getenv("bcgn")
